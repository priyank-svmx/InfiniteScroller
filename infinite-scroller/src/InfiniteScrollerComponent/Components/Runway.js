...
import { DataContext } from "../ComponentContext/Contexts";
import { events } from "../Enums/EventEnumeration";
...
export default class Runway extends Component {
  ...
  componentDidUpdate() {
    ...
    console.log("#🍺🍺🍺# checking state and scroll-values  #🍺🍺🍺#");
